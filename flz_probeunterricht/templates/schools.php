<div class="wrap">
    ...
    <div style="display: inline-block; width: 50%; overflow: auto; height: 20em;">
        <a href="<?= FlzPuSchool::get_csv_link()?>">CSV herunterladen</a>
        <table>
            <tr>
                <th>Name</th>
                <th>Freie Plätze</th>
            ...
            <?php foreach ( $schools as $school ) : ?>
                <tr>
                    ...
                    <td><?php echo $school->available_seats; ?></td>
                    <td>
                        <form method="post" style="display: inline;">
                            <input type="hidden" name="school_delete" value="<?php echo $school->id; ?>" />
    ...
    <div style="width: 40%; display: inline-block; vertical-align: top; text-align: start;">
        ...
        <form method="post">
            <input type="hidden" name="school_id" value="<?php echo $selected_school->id; ?>" />
            <label for="school">Name:</label>
            <input type="text" name="name" value="<?php echo $selected_school->name?>" required /><br>
            <label for="available_seats">Freie Plätze:</label>
            <input type="number" name="available_seats" value="<?php echo $selected_school->available_seats?>" required /><br>
